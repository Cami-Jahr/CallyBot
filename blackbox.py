...
class Facebook_tester:
    ...
    def ask_with_simple_text_responses(self):
        ...
        while queries:  # Ask and check while there are queries left
            ...
            old_elems = self.driver.find_elements_by_css_selector(
                "._3oh-._58nk")  # This is the class name for single messages, but accessed with css selector due to having spaces in the name
