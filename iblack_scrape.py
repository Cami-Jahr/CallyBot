...
def scrape(username, password):
    ...
    driver.get("https://ntnu.blackboard.com/webapps/portal/execute/tabs/tabAction?tab_tab_group_id=_65_1") # Go to course list
    try:
        wait.until(lambda driver: driver.find_element_by_id('block::1-dueView::1-dueView_1')) # Wait for the site to load properly
    except TimeoutException:
